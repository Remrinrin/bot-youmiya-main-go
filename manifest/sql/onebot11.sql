-- 创建消息类型枚举
CREATE TYPE message_type AS ENUM ('private', 'group');
CREATE TYPE post_type AS ENUM ('message', 'notice', 'request', 'meta');
...
-- 创建初始分区
CREATE TABLE onebot_messages_y2024m01 PARTITION OF onebot_messages
